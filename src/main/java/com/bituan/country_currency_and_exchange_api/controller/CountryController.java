...
public class CountryController {
    ...
    public ResponseEntity<List<CountryEntity>> getCountries (@RequestParam(required = false, name = "sort") String sortBy, FilterParamModel filters) throws HttpException {
